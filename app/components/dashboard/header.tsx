...
const Header = () => {
  return (
    <header className="md:flex md:justify-end items-center mb-10 px-5">
      {/* menu right */}
      <div className="flex items-center gap-5">
        <div className="p-1.5 px-5 text-primary rounded-md border-primary bg-black/5 text-sm flex gap-2 items-center">
          <svg
